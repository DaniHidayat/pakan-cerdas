    ...
    <div class="col-md-12 grid-margin">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{ route('admin.price.store') }}" method="POST" autocomplete="off">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="amount" class="form-control" id="amount" placeholder="Harga" value="{{ old('amount') }}">
                    </div>
                    <div class="form-group">
